...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show1String = settings.getString("Time1",defaultString);
        show2String = settings.getString("Time2",defaultString);
        show3String = settings.getString("Time3",defaultString);
    ...
    private void InitDelete1(){
        ...
        delete1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                am = (AlarmManager)getSystemService(ALARM_SERVICE);
                am.cancel(sender);
                Toast.makeText(MainActivity.this,"删除闹钟时间",Toast.LENGTH_SHORT).show();
                show1.setText("未设置闹钟");

                SharedPreferences time1Share = getPreferences(0);
                SharedPreferences.Editor editor = time1Share.edit();
                editor.putString("Time1","未设置闹钟");
                editor.commit();
            }
        });
    }
